/**
 * @file <argos3/plugins/robots/crazyflie/simulator/crazyflie_colored_blob_perspective_camera_default_sensor.cpp>
 *
 * @author Daniel H. Stolfi based on the Carlo Pinciroli's work
 *
 * ADARS project -- PCOG / SnT / University of Luxembourg
 */
#include "crazyflie_colored_blob_perspective_camera_default_sensor.h"
...
namespace argos {
   ...
   class CCrazyfliePerspectiveCameraLEDCheckOperation : public CPositionalIndex<CLEDEntity>::COperation {

   public:

      CCrazyfliePerspectiveCameraLEDCheckOperation(
         CCI_ColoredBlobPerspectiveCameraSensor::TBlobList& t_blobs,
         CCrazyflieCameraEquippedEntity& c_cam_entity,
      ...
      virtual ~CCrazyfliePerspectiveCameraLEDCheckOperation() {
   ...
   private:
      ...
      CCrazyflieCameraEquippedEntity& m_cCamEntity;
   ...
   CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::CCrazyflieColoredBlobPerspectiveCameraDefaultSensor() :
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::SetRobot(CComposableEntity& c_entity) {
      /* Get omndirectional camera equipped entity */
      m_pcCamEntity = &(c_entity.GetComponent<CCrazyflieCameraEquippedEntity>("perspective_camera"));
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Init(TConfigurationNode& t_tree) {
      try {
         /* Parent class init */
         ...
         m_pcOperation = new CCrazyfliePerspectiveCameraLEDCheckOperation(
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Update() {
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Reset() {
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Destroy() {
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Enable() {
   ...
   void CCrazyflieColoredBlobPerspectiveCameraDefaultSensor::Disable() {
   ...
   REGISTER_SENSOR(CCrazyflieColoredBlobPerspectiveCameraDefaultSensor,
                   "crazyflie_colored_blob_perspective_camera", "default",
