/**
 * @file <argos3/plugins/robots/crazyflie/simulator/crazyflie_camera_equipped_entity.h>
 *
...
#ifndef CRAZYFLIE_CAMERA_EQUIPPED_ENTITY_H
#define CRAZYFLIE_CAMERA_EQUIPPED_ENTITY_H
...
namespace argos {
   ...
   class CCrazyflieCameraEquippedEntity : public CEntity {
   ...
   public:
       ...
       */
      CCrazyflieCameraEquippedEntity(CComposableEntity* pc_parent);
...
//      }
      ...
      inline const CVector3 GetPosition() const {
         return m_psAnchor->Position + CVector3(0.02, 0.0, 0.015f).Rotate(m_psAnchor->Orientation);
      }
